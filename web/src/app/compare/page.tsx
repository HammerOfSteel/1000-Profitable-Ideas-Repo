...
function sortIdeas<T extends { pricePoint: { startingAt: number }; buildComplexity: string; status: string; validationScore: number }>(
  ideas: T[],
...
export default async function ComparePage({ searchParams }: ComparePageProps) {
  ...
  const allIdeas = flattenIdeas(dataset);
